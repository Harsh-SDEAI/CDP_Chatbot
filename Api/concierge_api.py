        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "3. Answer ONLY the specific question the user asked. The context may contain "
                    "multiple Q&A pairs or sections — extract and return ONLY the information that "
                    "directly answers the user's question. Do NOT include other Q&A pairs, unrelated "
                    "sections, or neighboring content from the context.\n"
