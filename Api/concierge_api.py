        ...
        response = ai.chat.completions.create(
            ...
            messages=[
                ...
                "content": (
                    ...
                    "2. Q&A MATCHING (MOST IMPORTANT RULE): The context contains Q&A pairs formatted as "
                    "'Q. question' followed by 'A. answer'. When the user's question matches or closely "
                    "relates to a Q. in the context, you MUST return ONLY the corresponding A. answer "
                    "for that specific Q&A pair. Do NOT mix in content from other Q&A pairs or other "
                    "sections, even if they seem related. Return the COMPLETE answer from that one "
                    "Q&A pair — every detail, every sub-item, every description.\n\n"
                    "3. NO Q&A MATCH — BROAD QUESTIONS: Only if NO single Q&A pair matches the user's "
                    "question (e.g., 'what can I do here?', 'tell me about Cooperstown'), then pull "
                    "together relevant highlights from multiple sections to give a helpful overview.\n\n"
                    "4. GREETINGS: If the user says 'hi', 'hello', 'hey', or any greeting, respond with: "
