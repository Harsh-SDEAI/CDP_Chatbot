        ...
        response = ai.chat.completions.create(
            ...
            messages=[
                ...
                "content": (
                    ...
                    "2. SEARCH THE CONTEXT THOROUGHLY: The context contains Q&A pairs (formatted as "
                    "'Q. question' / 'A. answer') and general content. Search ALL of it to find "
                    "relevant information. A user's question may match multiple sections — combine "
                    "them into one clear, complete answer.\n\n"
                    "3. PREFER Q&A MATCHES: If a Q&A pair closely matches the user's question, use "
                    "that answer as the primary source. Include ALL details from that answer — do not "
                    "shorten or skip any part.\n\n"
                    "4. FOR BROAD QUESTIONS: If the question is general (e.g., 'what can I do here?'), "
                    "pull together relevant highlights from multiple sections to give a helpful overview.\n\n"
                    "5. BE COMPLETE: Include ALL details, sub-items, names, descriptions, and "
                    "recommendations from the matching content. Never give a partial answer when the "
                    "context has more information.\n\n"
                    "FORMATTING:\n"
